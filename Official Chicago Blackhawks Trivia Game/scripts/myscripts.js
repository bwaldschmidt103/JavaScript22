...
const questions = [{
    ...
    {
        question: "Who was the first Blackhawks player to have his jersey number retired?", 
        answers: [
            { text: "Bobby Hull", correct: false },
	        { text: "Stan Mikita", correct: true },
        ...
        image: "images/stanMikitaRetired.jpg",
	clues: ["He was known for his curved stick.", "His number 21 was retired in 1980."]
    },
    {
        question: "Which Blackhawks player won the Calder Memorial Trophy in 2008?",
        answers: [
            { text: "Jonathan Toews", correct: false },
	        { text: "Patrick Kane", correct: true },
	        { text: "Duncan Keith", correct: false },
	        { text: "Brent Seabrook", correct: false },
	        { text: "Corey Crawford", correct: false } 
        ],
	image: "images/patrickKaneCalder.jpg",
	clues: ["He was the first overall pick in the 2007 NHL Draft.", "He is known for his incredible stickhandling skills."]
    },
    {
        question: "Who was the head coach of the Blackhawks during their 2013 and 2015 Stanley Cup wins?",
        answers: [
            { text: "Joel Quenneville", correct: true },
	        { text: "Denis Savard", correct: false },
	        { text: "Alain Vigneault", correct: false },
	        { text: "Mike Babcock", correct: false },
	        { text: "Scotty Bowman", correct: false } 
        ],
	image: "images/joelQuenneville.jpg",
	clues: ["He is the second-winningest coach in NHL history.", "He is known for his distinctive mustache."]
    },
    {
        question: "Which Blackhawks player scored the overtime goal to win the 2010 Stanley Cup?",
        answers: [
            { text: "Patrick Kane", correct: true },
	        { text: "Jonathan Toews", correct: false },
	        { text: "Dustin Byfuglien", correct: false },
	        { text: "Marian Hossa", correct: false },
	        { text: "Andrew Ladd", correct: false } 
        ],
        image: "images/patrickKane2010.jpg",
	clues: ["The goal was scored against the Philadelphia Flyers.", "He is known for his incredible stickhandling skills."]
    },
    {
        question: "Who was the first Blackhawks goaltender to win the Vezina Trophy?",
        answers: [
            { text: "Tony Esposito", correct: true },
	        { text: "Glenn Hall", correct: false },
	        { text: "Corey Crawford", correct: false },
	        { text: "Ed Belfour", correct: false },
	        { text: "Charlie Gardiner", correct: false } 
        ],
        image: "images/tonyEsposito.jpg",
	clues: ["He won the trophy in his rookie season.", "He is known for his butterfly style of goaltending."]
    }];
